...
A standard protocol that allows agents to send UI to surfaces. This is what we already designed, but the proposal is to make it generic to the component catalog, to allow for custom components.
